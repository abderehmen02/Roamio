...
return     <div className="flex gap-2 py-2 px-2 flex-col items-center" >
    <div  className="py-1 cursor-pointer hoverSettingsList hover:leading-8 thinBorderBottom  px-2 border-black w-full " ><H4 className="w-full text-center" >Saved Cities</H4></div> 
    <div  className="py-1 cursor-pointer hoverSettingsList thinBorderBottom px-2   border-black w-full " ><H4 className="w-full text-center" > Your Notes</H4></div>
    </div>
