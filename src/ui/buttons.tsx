...
export const SecondaryBtn : React.FC<ButtonHTMLAttributes<HTMLDivElement>>  = ({children , className , ...props })=>{
...
export const TextButton : React.FC<ButtonHTMLAttributes<HTMLButtonElement>>  = ({children , className , ...props })=>{
