...
return  <button  className={cn("bg-primary  hover:bg-white  hover:text-primary  text-lg rounded-3xl font-bold px-4 py-2  hover:outline hover:outline-2 hover:outline-primary   text-white  shadow-md" , montserratClassName , className)} {...props} >{children}</button>
}

export const SecondaryBtn : React.FC<HTMLAttributes<HTMLDivElement>>  = ({children , className , ...props })=>{
return  <button  className={cn( " bg-secondary hover:bg-secondaryDark text-lg rounded-3xl font-bold px-4 py-2 shadow-md" , montserratClassName, className)} >{children}</button>
}
