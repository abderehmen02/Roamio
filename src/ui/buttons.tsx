...
export const SecondaryBtn : React.FC<UiButtonProps>  = ({children , className , size , ...props })=>{
...
export const TextButton : React.FC<UiButtonProps>  = ({children , size , className , ...props })=>{
