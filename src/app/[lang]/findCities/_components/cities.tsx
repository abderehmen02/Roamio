...
export const Cities : React.FC<{prefrencesModal : boolean , setPrefrencesModal : Dispatch<SetStateAction<boolean>>
    ...
    if(cities.loading && !cities.cities.length ) return <div style={{height : '50px'}} className="flex pt-10 largeMonitor:pt-0 flex-col relative w-full  z-0 largeMonitor:w-[85%] items-center gap-10 " >
