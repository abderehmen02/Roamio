...
return <form onSubmit={handleSubmit((data)=>submitSignUp(data , setFieldsErrors , emitAction  ))} className="bg-white px-4 laptop:px-10 shadow-lg gap-10 py-5 signUpForm  h-fit rounded-lg items-start  flex flex-col" >
