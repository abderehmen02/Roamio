...
return    <div className="flex w-[97vw] gap-7   py-6 flex-col" >
    <div className="flex flex-col gap-3" >
   <ButtonInfoSection button={<Link href={appConfig.links.blog}><SecondaryBtn>Explore Landmarks</SecondaryBtn></Link>} className="laptop:mx-14 my-9" title="Landmark Odyssey, Immerse Yourself in the Cultural Tapestry of City Icons" descreption="embark on a cultural voyage through city icons. Our curated guide unveils the world's most renowned landmarks, offering immersive insights into history, art, and architecture across diverse global destinations." />
   <div style={{ paddingLeft : "4vw", gap : "4vw" , transform : "translateX(-25vw)"}} className="hidden laptop:flex   items-center justify-center  w-fit" >
